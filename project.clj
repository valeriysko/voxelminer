(defproject voxel-miner "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "voxel-miner.core/on-js-reload"
                ...
                :compiler {:main voxel-miner.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/voxel_miner.js"
